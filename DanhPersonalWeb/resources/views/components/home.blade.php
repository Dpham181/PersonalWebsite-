...
@section('content')
  ...
  <img  height="200" width="200" src="{{asset('css/logo/danh.jpg')}}" class=" animated rotateIn rounded-circle" alt="woman avatar">
...
<span class="sr-only">Loading...</span>
        ...
        <a href="https://github.com/Dpham181" class="btn btn-outline-white btn-md"><i class="fas fa-clone left"></i> View My Previous projects Via Github</a>
      </div>
    </div>
  </div>
